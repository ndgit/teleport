...
// file: v1/terminal_service.proto
...
import * as v1_node_pb from "../v1/node_pb";
...
export class CreateGatewayRequest extends jspb.Message {
  ...
  hasGateway(): boolean;
  clearGateway(): void;
  getGateway(): v1_gateway_pb.Gateway | undefined;
  setGateway(value?: v1_gateway_pb.Gateway): void;
...
export namespace CreateGatewayRequest {
  export type AsObject = {
    clusterId: string,
    gateway?: v1_gateway_pb.Gateway.AsObject,
  }
}
...
export class ListNodesResponse extends jspb.Message {
  clearNodesList(): void;
  getNodesList(): Array<v1_node_pb.Node>;
  setNodesList(value: Array<v1_node_pb.Node>): void;
  addNodes(value?: v1_node_pb.Node, index?: number): v1_node_pb.Node;
...
export namespace ListNodesResponse {
  export type AsObject = {
    nodesList: Array<v1_node_pb.Node.AsObject>,
    nextPageToken: string,
  }
}
